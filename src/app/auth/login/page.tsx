...
export default function LoginPage() {
  ...
  if (status === "authenticated" && session?.user) {
    return (
      <div className="min-h-screen flex items-center justify-center p-8" style={{ background: "#0E1512" }}>
        <div
          className="w-full max-w-md p-8 rounded-xl"
          style={{ background: "#141C18", border: "1px solid #26312B" }}
        >
          <div className="text-center mb-6">
            <div
              className="w-12 h-12 mx-auto mb-4 border flex items-center justify-center"
              style={{
                borderColor: "#C9A227",
                color: "#C9A227",
            ...
            <p className="mt-2" style={{ fontSize: "13px", color: "#8A9690" }}>
              You are signed in as <strong style={{ color: "#EDE8DD" }}>{session.user.name}</strong> ({session.user.role?.replace("_", " ")})
            </p>
          </div>
